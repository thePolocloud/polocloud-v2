...
import dev.httpmarco.polocloud.node.modules.ModuleProviderImpl;
...
public final class Node extends CloudAPI {
    ...
    private final ModuleProviderImpl moduleProvider;
    ...
    public Node() {
        ...
        this.moduleProvider = new ModuleProviderImpl();
