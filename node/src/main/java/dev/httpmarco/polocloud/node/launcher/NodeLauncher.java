...
public class NodeLauncher {
    public static void main(String[] args) {
        ...
        var slf4jDependency = new Dependency("org.slf4j", "slf4j-api", "2.0.13");
        var log4jApiDependency = new Dependency("org.apache.logging.log4j", "log4j-api", "2.23.1");
        ...
        DependencyDownloader.download(slf4jDependency, log4jApiDependency, log4jCoreDependency, log4jSlf4jDependency, jlineDependency);
